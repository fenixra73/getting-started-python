...
PROJECT_ID = 'bookshelf-new'

# CloudSQL & SQLAlchemy configuration
# Replace the following values the respective values of your Cloud SQL
# instance.
CLOUDSQL_USER = 'user-db'
CLOUDSQL_PASSWORD = 'S3MeisojIrhI2qfpGlDW5g=='
CLOUDSQL_DATABASE = 'bookshelf'
# Set this value to the Cloud SQL connection name, e.g.
#   "project:region:cloudsql-instance".
# You must also update the value in app.yaml.
CLOUDSQL_CONNECTION_NAME = 'bookshelf-new:us-central1:db-bookshelf-db'
...
CLOUD_STORAGE_BUCKET = 'bookshelf-pic-storage'
